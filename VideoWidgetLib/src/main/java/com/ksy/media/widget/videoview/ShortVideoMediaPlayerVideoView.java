 ...
 * 
 */
public class ShortVideoMediaPlayerVideoView extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = ShortVideoMediaPlayerVideoView.class.getName();
	...
	private ShortVideoMediaPlayerView.IStop callBack;

	public ShortVideoMediaPlayerVideoView(Context context) {

		super(context);
		initVideoView(context);
	}

	public ShortVideoMediaPlayerVideoView(Context context, AttributeSet attrs) {
	...
	// stop get flow timer
	public void setCallBack(ShortVideoMediaPlayerView.IStop callBack) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(ShortVideoMediaPlayerVideoView.KEY_SOUCE_IP);
