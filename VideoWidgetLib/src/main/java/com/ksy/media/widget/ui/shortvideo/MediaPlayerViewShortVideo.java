...
public class MediaPlayerViewShortVideo extends RelativeLayout implements
        IPowerStateListener {
...
//	private MediaPlayerTexutureVideoView mMediaPlayerVideoView;
    ...
    public MediaPlayerViewShortVideo(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MediaPlayerViewShortVideo(Context context, AttributeSet attrs) {
    ...
    public MediaPlayerViewShortVideo(Context context) {
            ...
            if (!mScreenshotPreparing) {
                ...
                if (bitmap != null) {
                    ...
                    compressAndSaveBitmapToSDCard(bitmap, getCurrentTime(),
                            MediaPlayerViewShortVideo.QUALITY_BEST);
                    /*
                     * Toast.makeText( getContext(),
    ...
    private void compressAndSaveBitmapToSDCard(Bitmap rawBitmap,
        ...
        File directory = new File(Environment.getExternalStorageDirectory()
                + File.separator + MediaPlayerViewShortVideo.CAPUTRE_SCREEN_PATH);
        if (!directory.exists()) {
            directory.mkdir();
        }
