 ...
 * 
 */
public class StreamMediaPlayerVideoView extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = StreamMediaPlayerVideoView.class.getName();
	...
	private StreamMediaPlayerView.IStop callBack;

	public StreamMediaPlayerVideoView(Context context) {

		super(context);
		initVideoView(context);
	}

	public StreamMediaPlayerVideoView(Context context, AttributeSet attrs) {
	...
	// stop get flow timer
	public void setCallBack(StreamMediaPlayerView.IStop callBack) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(StreamMediaPlayerVideoView.KEY_SOUCE_IP);
