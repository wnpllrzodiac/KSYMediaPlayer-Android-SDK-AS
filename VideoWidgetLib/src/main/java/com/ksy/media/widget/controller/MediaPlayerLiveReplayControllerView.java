...
public class MediaPlayerLiveReplayControllerView extends MediaPlayerBaseControllerView implements View.OnClickListener {
	...
	public MediaPlayerLiveReplayControllerView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public MediaPlayerLiveReplayControllerView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MediaPlayerLiveReplayControllerView(Context context) {
		super(context);
