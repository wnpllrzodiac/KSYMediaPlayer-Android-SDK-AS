 ...
 * 
 */
public class MediaPlayerVideoViewVideo extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = MediaPlayerVideoViewVideo.class.getName();
	...
	private MediaPlayerViewVideo.IStop callBack;

	public MediaPlayerVideoViewVideo(Context context) {

		super(context);
		initVideoView(context);
	}

	public MediaPlayerVideoViewVideo(Context context, AttributeSet attrs) {
	...
	// stop get flow timer
	public void setCallBack(MediaPlayerViewVideo.IStop callBack) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(MediaPlayerVideoViewVideo.KEY_SOUCE_IP);
