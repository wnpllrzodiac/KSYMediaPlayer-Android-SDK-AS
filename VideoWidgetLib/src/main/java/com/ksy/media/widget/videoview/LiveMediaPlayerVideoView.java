 ...
 * 
 */
public class LiveMediaPlayerVideoView extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = LiveMediaPlayerVideoView.class.getName();
	...
	public LiveMediaPlayerVideoView(Context context) {

		super(context);
		initVideoView(context);
	}

	public LiveMediaPlayerVideoView(Context context, AttributeSet attrs) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(LiveMediaPlayerVideoView.KEY_SOUCE_IP);
