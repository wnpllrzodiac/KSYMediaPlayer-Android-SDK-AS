...
public class VideoListAdapter extends BaseAdapter {
    ...
    private final ArrayList<VideoCommentItem> items;
    private final Context context;

    public VideoListAdapter(Context context, ArrayList<VideoCommentItem> items) {
    ...
    @Override
    public VideoCommentItem getItem(int position) {
