 ...
 * 
 */
public class LiveReplayMediaPlayerVideoView extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = LiveReplayMediaPlayerVideoView.class.getName();
	...
	private LiveReplayMediaPlayerControllerView.LiveReplayMediaPlayerController mMediaPlayerController;
	...
	public LiveReplayMediaPlayerVideoView(Context context, AttributeSet attrs) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(LiveReplayMediaPlayerVideoView.KEY_SOUCE_IP);
	...
	public void setMediaPlayerController(
			LiveReplayMediaPlayerControllerView.LiveReplayMediaPlayerController liveMediaPlayerController) {

		mMediaPlayerController = liveMediaPlayerController;
	}
	...
	SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			...
			// }else {
			// isNeedHandlerOpen = true;
			// Log.d(Constants.LOG_TAG,
			// "is releasing ,wating for handler, surfaceCreated do nothing");
			// }
