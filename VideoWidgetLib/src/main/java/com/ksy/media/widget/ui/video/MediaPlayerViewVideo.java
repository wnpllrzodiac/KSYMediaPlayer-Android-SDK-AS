...
import com.ksy.media.widget.videoview.MediaPlayerVideoViewVideo;
...
public class MediaPlayerViewVideo extends RelativeLayout implements
		IPowerStateListener {
...
//	private MediaPlayerTexutureVideoView mMediaPlayerVideoView;
	private MediaPlayerVideoViewVideo mMediaPlayerVideoView;
	...
	public MediaPlayerViewVideo(Context context, AttributeSet attrs, int defStyle) {
	...
	public MediaPlayerViewVideo(Context context, AttributeSet attrs) {
	...
	public MediaPlayerViewVideo(Context context) {
	...
	private void init(Context context, AttributeSet attrs, int defStyle)
		...
		this.mMediaPlayerVideoView = (MediaPlayerVideoViewVideo) mRootView
			...
			if (!mScreenshotPreparing) {
				...
				if (bitmap != null) {
					...
					compressAndSaveBitmapToSDCard(bitmap, getCurrentTime(),
							MediaPlayerViewVideo.QUALITY_BEST);
					/*
					 * Toast.makeText( getContext(),
	...
	private void compressAndSaveBitmapToSDCard(Bitmap rawBitmap,
		...
		File directory = new File(Environment.getExternalStorageDirectory()
				+ File.separator + MediaPlayerViewVideo.CAPUTRE_SCREEN_PATH);
		if (!directory.exists()) {
			directory.mkdir();
		}
