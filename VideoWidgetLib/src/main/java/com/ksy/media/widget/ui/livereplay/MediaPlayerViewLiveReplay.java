...
import com.ksy.media.widget.controller.MediaPlayerLiveReplayControllerView;
...
//	private MediaPlayerTexutureVideoView mMediaPlayerVideoView;
	...
	private MediaPlayerLiveReplayControllerView mMediaPlayerLiveReplayControllerView;
...
//							mMediaPlayerLiveReplayControllerView.hide();
		...
		/* 初始化:ControllerViewLarge */
		this.mMediaPlayerLiveReplayControllerView
				.setMediaPlayerController(mMediaPlayerController);
		this.mMediaPlayerLiveReplayControllerView.setHostWindow(mWindow);
		this.mMediaPlayerLiveReplayControllerView
				.setDeviceNavigationBarExist(mDeviceNavigationBarExist);
		this.mMediaPlayerLiveReplayControllerView.setNeedGestureDetector(true);
		this.mMediaPlayerLiveReplayControllerView.setNeedGestureAction(false, false,
				false);
