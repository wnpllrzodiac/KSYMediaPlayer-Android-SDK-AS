 ...
 * 
 */
public class MediaPlayerVideoViewShortVideo extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = MediaPlayerVideoViewShortVideo.class.getName();
	...
	private MediaPlayerViewShortVideo.IStop callBack;

	public MediaPlayerVideoViewShortVideo(Context context) {

		super(context);
		initVideoView(context);
	}

	public MediaPlayerVideoViewShortVideo(Context context, AttributeSet attrs) {
	...
	// stop get flow timer
	public void setCallBack(MediaPlayerViewShortVideo.IStop callBack) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(MediaPlayerVideoViewShortVideo.KEY_SOUCE_IP);
