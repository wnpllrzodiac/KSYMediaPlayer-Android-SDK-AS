 ...
 * 
 */
public class VideoMediaPlayerVideoView extends SurfaceView implements
		IMediaPlayerControl, IPowerStateListener {

	private static final String TAG = VideoMediaPlayerVideoView.class.getName();
	...
	private VideoMediaPlayerView.IStop callBack;

	public VideoMediaPlayerVideoView(Context context) {

		super(context);
		initVideoView(context);
	}

	public VideoMediaPlayerVideoView(Context context, AttributeSet attrs) {
	...
	// stop get flow timer
	public void setCallBack(VideoMediaPlayerView.IStop callBack) {
	...
	OnPreparedListener mPreparedListener = new OnPreparedListener() {
		...
		public void onPrepared(IMediaPlayer mp) {
			...
			String source_ip = bundle
					.getString(VideoMediaPlayerVideoView.KEY_SOUCE_IP);
