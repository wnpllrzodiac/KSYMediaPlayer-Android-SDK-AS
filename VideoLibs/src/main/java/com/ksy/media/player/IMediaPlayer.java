...
//	public static final int MEDIA_BUFFERSIZE_DEFAULT = 1;
	...
	public abstract void setOnDebugInfoListener(
			OnDebugInfoListener mOnDebugInfoListener);
	
	public abstract void setOnNetSpeedUpdateListener(OnNetSpeedListener listener);
	...
	public static interface OnNetSpeedListener {
		
		public void onNetSpeedUpdate(IMediaPlayer mp, int arg1, int arg2);
	}
	
	public static interface OnDebugInfoListener {
	...
	public abstract void setLowDelayEnabled(int mode, int start_drop_frame_threshold,
											int stop_drop_frame_threshold);
	
	public abstract void setRetryCount(int retry_count);
	
	public abstract void setRetryAlways();
