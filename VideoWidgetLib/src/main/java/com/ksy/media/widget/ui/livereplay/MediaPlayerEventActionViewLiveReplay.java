...
public class MediaPlayerEventActionViewLiveReplay extends RelativeLayout {
	...
	public MediaPlayerEventActionViewLiveReplay(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public MediaPlayerEventActionViewLiveReplay(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MediaPlayerEventActionViewLiveReplay(Context context) {
		super(context);
